...
<div class="content-wrapper ">
						...
						<div class="row table-cell">
							...
							<div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0 col-xs-12">
								...
								<div class="slider-content align-center">
									...
									<h6 class="slider-content-text" data-swiper-parallax="-200">Established in 2014,
										<b>NABLE INVENT SOLUTION</b> is a business process technology and IT services & consulting company
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								<div class="slider-thumb" data-swiper-parallax="-400" data-swiper-parallax-duration="600">
									<img src="<?php echo base_url("assets/site/"); ?>img/slides1.png" alt="slider">
								</div>
							</div>
							...
							<div class="col-lg-5 col-md-12 col-sm-12 col-xs-12">
								<div class="slider-content align-both">
									<h2 class="slider-content-title" data-swiper-parallax="-100">
										<span class="c-primary">NABLE INVENT SOLUTION </span>
						...
						<div class="row table-cell">
							<div class="col-lg-6 col-sm-12 table-cell">
								...
								<div class="slider-content align-both">
									...
									<h6 class="slider-content-text" data-swiper-parallax="-200">We make our
										...
										business process.
										At <b>NABLE INVENT SOLUTION</b>, we’re passionate about bringing simplicity, innovation and
							...
							<div class="col-lg-6 col-sm-12 table-cell">
								<div class="slider-thumb" data-swiper-parallax="-300" data-swiper-parallax-duration="500">
									<img src="<?php echo base_url("assets/site/"); ?>img/slides2.png" alt="slider">
								</div>
							</div>
			...
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="crumina-module crumina-info-box info-box--standard-hover">
						...
						<div class="info-box-image">
							<img class="utouch-icon" src="<?php echo base_url("assets/site/"); ?>svg-icons/businesstech.svg">
							<!--<img class="cloud" src="<?php echo base_url("assets/site/"); ?>svg-icons/businesstech.svg">-->
						</div>

						<div class="info-box-content">
							<a href="<?php echo base_url('web/bpt'); ?>" class="h5 info-box-title">Business Process Technology</a>

						</div>

						<a href="<?php echo base_url('web/bpt'); ?>" class="btn-next">
							<svg class="utouch-icon icon-hover utouch-icon-arrow-right-1">
								<use xlink:href="#utouch-icon-arrow-right-1"></use>
							</svg>
							<svg class="utouch-icon utouch-icon-arrow-right1">
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="crumina-module crumina-info-box info-box--standard-hover">
						...
						<div class="info-box-image">
							<img class="utouch-icon" src="<?php echo base_url("assets/site/"); ?>svg-icons/partnership.svg" alt="smartphone">
							<!--<img class="cloud" src="<?php echo base_url("assets/site/"); ?>svg-icons/partnership.svg" alt="cloud">-->
						</div>

						<div class="info-box-content">
							<a href="<?php echo base_url('web/teamextension'); ?>" class="h5 info-box-title">Team Extension | Offshore Development Center</a>

						</div>

						<a href="<?php echo base_url('web/teamextension'); ?>" class="btn-next">
							<svg class="utouch-icon icon-hover utouch-icon-arrow-right-1">
								<use xlink:href="#utouch-icon-arrow-right-1"></use>
							</svg>
							<svg class="utouch-icon utouch-icon-arrow-right1">
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="crumina-module crumina-info-box info-box--standard-hover">
						...
						<div class="info-box-image">
							<img class="utouch-icon" src="<?php echo base_url("assets/site/"); ?>svg-icons/smartphone.svg" alt="smartphone">
							<!--<img class="cloud" src="<?php echo base_url("assets/site/"); ?>svg-icons/smartphone.svg" alt="cloud">-->
						</div>

						<div class="info-box-content">
							<a href="<?php echo base_url('web/softwaredevelopment'); ?>" class="h5 info-box-title">Custom Software Development</a>

						</div>
						<a href="<?php echo base_url('web/softwaredevelopment'); ?>" class="btn-next">
							<svg class="utouch-icon icon-hover utouch-icon-arrow-right-1">
								<use xlink:href="#utouch-icon-arrow-right-1"></use>
							</svg>
							<svg class="utouch-icon utouch-icon-arrow-right1">
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
					<div class="crumina-module crumina-info-box info-box--standard-hover">
						...
						<div class="info-box-image">
							<img class="utouch-icon" src="<?php echo base_url("assets/site/"); ?>img/devopsnew.png">
							<!--<img class="cloud" src="<?php echo base_url("assets/site/"); ?>img/devopsnew.png">-->
						</div>

						<div class="info-box-content">
							<a href="<?php echo base_url('web/Devops'); ?>" class="h5 info-box-title">DevOps : Hire <b>NABLE INVENT SOLUTION</b> DevOps Consulting Services.</a>

						</div>
						<a href="<?php echo base_url('web/Devops'); ?>" class="btn-next">
							<svg class="utouch-icon icon-hover utouch-icon-arrow-right-1">
								<use xlink:href="#utouch-icon-arrow-right-1"></use>
							</svg>
							<svg class="utouch-icon utouch-icon-arrow-right1">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="crumina-module crumina-info-box info-box--standard-hover">
						...
						<div class="info-box-image">
							<img class="utouch-icon" src="<?php echo base_url("assets/site/"); ?>svg-icons/producteng.svg">
							<!--<img class="cloud" src="<?php echo base_url("assets/site/"); ?>svg-icons/producteng.svg">-->
						</div>

						<div class="info-box-content">
							<a href="<?php echo base_url('web/productengineering'); ?>" class="h5 info-box-title">Product Engineering</a>

						</div>
						<a href="<?php echo base_url('web/productengineering'); ?>" class="btn-next">
							<svg class="utouch-icon icon-hover utouch-icon-arrow-right-1">
								<use xlink:href="#utouch-icon-arrow-right-1"></use>
							</svg>
							<svg class="utouch-icon utouch-icon-arrow-right1">
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="crumina-module crumina-info-box info-box--standard-hover">
						...
						<div class="info-box-image">
							<img class="utouch-icon" src="<?php echo base_url("assets/site/"); ?>svg-icons/call-center.svg">
							<!--<img class="cloud" src="<?php echo base_url("assets/site/"); ?>svg-icons/call-center.svg">-->
						</div>

						<div class="info-box-content">
							<a href="<?php echo base_url('web/bpo'); ?>" class="h5 info-box-title">BPO Services</a>

						</div>

						<a href="<?php echo base_url('web/bpo'); ?>" class="btn-next">
							<svg class="utouch-icon icon-hover utouch-icon-arrow-right-1">
								<use xlink:href="#utouch-icon-arrow-right-1"></use>
							</svg>
							<svg class="utouch-icon utouch-icon-arrow-right1">
				...
				<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
					<div class="crumina-module crumina-info-box info-box--standard-hover">
						...
						<div class="info-box-image">
							<img class="utouch-icon" src="<?php echo base_url("assets/site/"); ?>svg-icons/application.svg">
							<!--<img class="cloud" src="<?php echo base_url("assets/site/"); ?>svg-icons/application.svg">-->
						</div>

						<div class="info-box-content">
							<a href="<?php echo base_url('web/appDeveloper'); ?>" class="h5 info-box-title">Application Development</a>
						...
						<a href="<?php echo base_url('web/appDeveloper'); ?>" class="btn-next">
							<svg class="utouch-icon icon-hover utouch-icon-arrow-right-1">
								<use xlink:href="#utouch-icon-arrow-right-1"></use>
							</svg>
							<svg class="utouch-icon utouch-icon-arrow-right1">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-12 col-sm-12">
					<img src="<?php echo base_url('assets/site/'); ?>/img/home/timeline.png" alt="image" class="display-block">
				</div>
				...
				<!--						<p class="info-box-text"><b>Sysorex</b> was born with 2 like-minded technocrats.-->
				...
				<!--							version of enterprise solution “<b>sysorex</b> xCellence”</p>-->
				<!--					</div>-->
				...
				<!--							under <b>Sysorex</b> group for empower of women under the umbrella of skill-->
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
					<div class="crumina-module crumina-our-video video-container ">
						<div class="video-thumb ">
							<video controls id="<b>sysorex</b>Video" poster="<?php echo base_url('assets/site/'); ?>img/videobanner.png">
								<source src="<?php echo base_url("assets/site/"); ?>video/video1.mp4" type=video/mp4>
							</video>
						</div>
					</div>
				</div>
					...
					<div class="row dis-flex align-items-center">
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<div class="crumina-module crumina-heading">
								...
								<h2 class="heading-title">The <span class="c-primary"><b>NABLE INVENT SOLUTION</b></span> maneuver</h2>
								<p class="heading-text">In our journey of over 3 years, we have initiated some of
									the major
									changes that have led to <b>NABLE INVENT SOLUTION</b> emergence as the leader destination for software
									services
				...
				<div class="box">
					...
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 padding-1">
						<a class="clients-item justify-center" href="https://dotnet.microsoft.com/">
							<img src="<?php echo base_url("assets/site/"); ?>img/vbnet.jpeg" class="" alt="logo">
						</a>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 padding-1">
						<a class="clients-item justify-center" href="https://www.php.net/">
							<img src="<?php echo base_url("assets/site/"); ?>svg-icons/php.svg" class="" alt="logo">
						</a>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 padding-1">
						<a class="clients-item justify-center" href="https://nodejs.org/en/">
							<img src="<?php echo base_url("assets/site/"); ?>svg/nodejs.svg" class="" alt="logo">
						</a>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 padding-1">
						<a class="clients-item justify-center" href="https://www.oracle.com/index.html">
							<img src="<?php echo base_url("assets/site/"); ?>svg/java.svg" class="" alt="logo">
						</a>
					</div>
					<!--Frontend-->
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 padding-1">
						<a class="clients-item justify-center" href="https://reactjs.org/">
							<img src="<?php echo base_url("assets/site/"); ?>svg/react.svg" class="" alt="logo">
						</a>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 padding-1">
						<a class="clients-item justify-center" href="https://angular.io/">
							<img src="<?php echo base_url("assets/site/"); ?>svg/angular.svg" class="" alt="logo">
						</a>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 padding-1">
						<a class="clients-item justify-center" href="https://flutter.dev/">
							<img src="<?php echo base_url("assets/site/"); ?>svg/flutter.svg" class="" alt="logo">
						</a>
					</div>
					<!--Frameworks-->
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 padding-1">
						<a class="clients-item justify-center" href="https://laravel.com/">
							<img src="<?php echo base_url("assets/site/"); ?>svg/laravel.svg" class="" alt="logo">
						</a>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 padding-1">
						<a class="clients-item justify-center" href="https://www.djangoproject.com/">
							<img src="<?php echo base_url("assets/site/"); ?>svg/django.svg" class="" alt="logo">
						</a>
					</div>
				</div>
			</div>
	...
	<!--									<img class="utouch-icon" src="<?php echo base_url("assets/site/"); ?>img/arabiancomp.png" alt="image">-->
	<!--								</div>-->
	<!--							</div>-->
	...
	<!--									</div>-->
	<!--									<div class="col-lg-6 col-md-6 col-sm-12">-->
	<!--										<p><b>Sysorex</b> successfully implemented trading enterprise solution to cater-->
	...
	<!--							<div class="col-lg-4 col-md-12 col-sm-12" data-swiper-parallax="-100">-->
	<!--								<div class="slider-faqs-thumb">-->
	<!--									<img class="utouch-icon" src="<?php echo base_url("assets/site/"); ?>img/ERLOGO-black.png" alt="image">-->
	<!--								</div>-->
	<!--							</div>-->
	...
	<!--							<div class="col-lg-4 col-md-12 col-sm-12" data-swiper-parallax="-100">-->
	<!--								<div class="slider-faqs-thumb">-->
	<!--									<img class="utouch-icon" src="<?php echo base_url("assets/site/"); ?>img/idc.png" alt="image">-->
	<!--								</div>-->
	<!--							</div>-->
	...
	<!--									<b>Sysorex</b> successfully implemented enterprise solution to take care all of the-->
	...
	<!--							<div class="col-lg-4 col-md-12 col-sm-12" data-swiper-parallax="-100">-->
	<!--								<div class="slider-faqs-thumb">-->
	<!--									<img class="utouch-icon" src="<?php echo base_url("assets/site/"); ?>img/adaacorp.png" alt="image">-->
	<!--								</div>-->
	<!--							</div>-->
	...
	<!--									commissioning.-->
	<!--								</p>-->
	<!--								<p><b>Sysorex</b> successfully implemented enterprise solution to take care the manpower-->
	...
	<!--							<div class="col-lg-4 col-md-12 col-sm-12" data-swiper-parallax="-100">-->
	<!--								<div class="slider-faqs-thumb">-->
	<!--									<img class="utouch-icon" src="<?php echo base_url("assets/site/"); ?>img/racingfed.png" alt="image">-->
	<!--								</div>-->
	<!--							</div>-->
	...
	<!--											Federation'.-->
	<!--											<b>Sysorex</b> successfully implemented enterprise solution to take care the-->
	...
	<!--							<div class="col-lg-4 col-md-12 col-sm-12" data-swiper-parallax="-100">-->
	<!--								<div class="slider-faqs-thumb">-->
	<!--									<img class="utouch-icon" src="<?php echo base_url("assets/site/"); ?>img/emplojo-logo-6.png" alt="image">-->
	<!--								</div>-->
	<!--							</div>-->
	...
	<section class="crumina-module crumina-module-slider slider-tabs-vertical-line">
		<h2 class="heading-title text-align-center">Milestones</h2>
		<div class="swiper-container">
			<div class="swiper-wrapper">
				<div class="swiper-slide bg-blue-lighteen bg-5">
					<div class="container">
						<div class="row">
							<div class="col-lg-8 col-lg-offset-2">
								<div class="crumina-module crumina-heading">
									<!-- <h6 class="heading-sup-title">User Interface</h6> -->
									<img src="<?php echo base_url("assets/site/"); ?>img/arabiancomp.png">
									<h2 class="heading-title">Arabian Group of Companies</h2>
									<div class="heading-text">Arabian is a 100% locally owned entity founded in
										1967, has been
										instrumental in introducing different subsidiaries that complement
										each other with the focused view of offering customers a
										one-stop-shop for all their interior turnkey solutions.
										NABLE INVENT SOLUTION successfully implemented trading enterprise solution to cater
										multi-dimensional trading requirements of the group which included: Whole
										sale Trading, Retail Trading,
										Project based Trading, Assemble to order trading & POS solutions etc.
									</div>
								</div>
							</div>
						</div>
				...
				<div class="swiper-slide bg-blue-lighteen bg-6">
					<div class="container">
						<div class="row">
							<div class="col-lg-8 col-lg-offset-2">
								<div class="crumina-module crumina-heading">
									<!-- <h6 class="heading-sup-title">User Interface</h6> -->
									<img src="<?php echo base_url("assets/site/"); ?>img/ERLOGO-black.png">
									<h2 class="heading-title">Etihad railway – China Railway Construction
										Company (CRCC)</h2>
									<div class="heading-text">Etihad Rail was established in June 2009 by UAE
										Federal Decree to manage the
										development, construction and operation of the United Arab Emirates’
										national freight and passenger railway network.
										Etihad Rail utilizes it's resources in the efficient and effective shipment
										and logistics services. A few of the services which they offer are: Frieght Services : Shipping and Logistics, Property Development: Warehousing, Facility
										Development and Loading-unloading operations, Advertising Space: Rolling Stock, in-terminal advertising etc., Terminal Services: Transit or loading and offloading
										at terminals or logistics hub.
									</div>
								</div>
							</div>
						</div>
				...
				<div class="swiper-slide bg-blue-lighteen bg-7">
					<div class="container">
						<div class="row">
							<div class="col-lg-8 col-lg-offset-2">
								<div class="crumina-module crumina-heading">
									<!-- <h6 class="heading-sup-title">User Interface</h6> -->
									<img src="<?php echo base_url("assets/site/"); ?>img/idc.png" class="img-w-100">
									<h2 class="heading-title">International Development Company</h2>
									<div class="heading-text">Based in Abu Dhabi, IDC is one of the leading
										companies operating in the oil,
										gas, power & water, petrochemical and project construction sectors in the
										UAE. Established in 1978, they have 38 years of accumulated knowledge,
										experience and expertise in these fields. NABLE INVENT SOLUTION successfully implemented
										enterprise solution to take care all of the
										back to back trading solutions with multiple currencies, cost estimation and
										job costing.
									</div>
									<h6 class="info-box-title">Quality Standards and Assurance</h6>
					...
					<div class="container">
						<div class="row">
							<div class="col-lg-8 col-lg-offset-2">
								<div class="crumina-module crumina-heading">
									<!-- <h6 class="heading-sup-title">User Interface</h6> -->
									<img src="<?php echo base_url("assets/site/"); ?>img/adaacorp.png" class="img-w-100">
									<h2 class="heading-title">Adaa Employment</h2>
									<div class="heading-text">ADAA is an established recruitment business with 10
										years
										of experience providing innovative, cost effective manpower solutions for
										construction, testing and
										commissioning. NABLE INVENT SOLUTION successfully implemented enterprise solution to take care
										the manpower
										supply requirements and management of operations
										related to managing the manpower resources from utilization, allocation,
										tracking, transportation etc.
					...
					<div class="container">
						<div class="row">
							<div class="col-lg-8 col-lg-offset-2">
								<div class="crumina-module crumina-heading">
									<!-- <h6 class="heading-sup-title">User Interface</h6> -->
									<img src="<?php echo base_url("assets/site/"); ?>img/racingfed.png">
									<h2 class="heading-title">UAE EQUESTRIAN AND RACING FEDERATION</h2>
									<div class="heading-text">The federation was established under the guidance of
										His Highness
										Sheikh Zayed bin Sultan Al Nahyan,
										founder of the United Arab Emirates, in accordance with the
										ministerial Resolution No. 61 (1992),
										under the name of the 'United Arab Emirates Equestrian and Racing
										Federation'.
										NABLE INVENT SOLUTION successfully implemented enterprise solution to take care the
										huge requirement of federation to address the operation and finance
										to bring in a single platform.
										We have implemented sys0rex xCellence and synchronize multiple
										application in record time.
					...
					<div class="container">
						<div class="row">
							<div class="col-lg-8 col-lg-offset-2">
								<div class="crumina-module crumina-heading">
									<!-- <h6 class="heading-sup-title">User Interface</h6> -->
									<img src="<?php echo base_url("assets/site/"); ?>img/emplojo-logo-6.png" class="img-w-100">
									<h2 class="heading-title">Emplojo</h2>
									<div class="heading-text">Based in Abu Dhabi, Emplojo is an application which
										connects job seekers to
										the required recruiters.
										This application provides the user to create a profile on the application,
										which later can be seen by a recruiter.
										The application allows the recruiter to filter the candidates based on
										different requirements as well such as profile, skills etc.
										the sys0rex team was involved in complete implementation of ths application
										right from development to delivery.
									</div>
								</div>
			...
			<div class="slider-slides slider-slides--vertical-line">
				...
				<a href="#" class="slides-item">
					<span class="round primary"></span>04.
				</a>

				<a href="#" class="slides-item">
					<span class="round red"></span>05.
				</a>
				<a href="#" class="slides-item">
					<span class="round primary"></span>06.
				</a>
			</div>
	...
	<!--<div class="row">-->
	<!-- <div class="col-md-6">
									<a href="<?php echo base_url("web/"); ?>training_details" class="btn btn--primary btn--with-shadow">
										Visit Online Courses
									</a>
								</div>
								<div class="col-md-6">
									<a href="<?php echo base_url("web/"); ?>courses" class="btn btn--primary btn--with-shadow">
										Visit Offline Courses
									</a>
								</div> -->
	<!-- </div>-->
	<!-- </div>
						...
						<div class="swiper-wrapper">
							<div class="crumina-module crumina-testimonial-item testimonial-item-author-top swiper-slide">
								...
								<div data-swiper-parallax="-100">
									<img src="<?php echo base_url("assets/site/"); ?>img/testimonial/testimonial1.png" class="avatar" alt="avatar">
								</div>

								<h6 class="testimonial-text" data-swiper-parallax="-300">
									We needed a solution that would merge all departments from Finance to operation and which would integrate with Federation, Inventory, Sales, Purchase, and HR/Payroll etc.
									...
									we are happy and believe all future requirements will be met with sys0rex xCellence ERP. I would not hesitate to recommend sys0rex xCellence ERP to any clients,
								...
								<div class="author-info-wrap" data-swiper-parallax="-100">
									...
									<div class="author-info">
										...
										<div class="author-company">Head of IT Department at UAE Equestrian And Racing Federation - إتحاداللإماراتللف</div>
									</div>
							...
							<div class="crumina-module crumina-testimonial-item testimonial-item-author-top swiper-slide">
								...
								<div data-swiper-parallax="-100">
									<img src="<?php echo base_url("assets/site/"); ?>img/testimonial/testimonial2.png" class="avatar" alt="avatar">
								</div>
							...
							<div class="crumina-module crumina-testimonial-item testimonial-item-author-top swiper-slide">
								...
								<div data-swiper-parallax="-100">
									<img src="<?php echo base_url("assets/site/"); ?>img/testimonial/testimonial3.png" class="avatar" alt="avatar">
								</div>
							...
							<div class="crumina-module crumina-testimonial-item testimonial-item-author-top swiper-slide">
								...
								<div data-swiper-parallax="-100">
									<img src="<?php echo base_url("assets/site/"); ?>img/testimonial/testimonial4.png" class="avatar" alt="avatar">
								</div>
								...
								<div class="author-info-wrap" data-swiper-parallax="-100">
									...
									<div class="author-info">
										<a href="#" class="h6 author-name">Sherief Al Gharabawy</a>
										<div class="author-company">Managing Director at ARCO Interiors LLC (Arabian Company Group)</div>
									</div>
							...
							<div class="crumina-module crumina-testimonial-item testimonial-item-author-top swiper-slide">
								...
								<div data-swiper-parallax="-100">
									<img src="<?php echo base_url("assets/site/"); ?>img/testimonial/testimonial5.png" class="avatar" alt="avatar">
								</div>
							...
							<div class="crumina-module crumina-testimonial-item testimonial-item-author-top swiper-slide">
								...
								<div data-swiper-parallax="-100">
									<img src="<?php echo base_url("assets/site/"); ?>img/testimonial/testimonial6.png" class="avatar" alt="avatar">
								</div>
	...
	<!--					<img class="img-bottom" src="<?php echo base_url("assets/site/"); ?>img/man2.png" alt="man">-->
	<!--				</div>-->
	...
	<!--															<img src="<?php echo base_url("assets/site/"); ?>img/testimonial/testimonial1.png" alt="author">-->
	<!--														</div>-->
	<!--														<div class="author-info">-->
	<!--															<a href="#" class="h6 author-name">Adnan Alsayadi</a>-->
	...
	<!--													<div class="author-info-wrap">-->
	<!--														<div class="testimonial-img-author">-->
	<!--															<img src="<?php echo base_url("assets/site/"); ?>img/testimonial/testimonial2.png" alt="author">-->
	<!--														</div>-->
	<!--														<div class="author-info">-->
	<!--															<a href="#" class="h6 author-name">Fayez Chaoul</a>-->
	<!--															<div class="author-company">Managing Director at Adaa Employment L.L.C</div>-->
	...
	<!--													<div class="author-info-wrap">-->
	<!--														<div class="testimonial-img-author">-->
	<!--															<img src="<?php echo base_url("assets/site/"); ?>img/testimonial/testimonial3.png" alt="author">-->
	<!--														</div>-->
	<!--														<div class="author-info">-->
	<!--															<a href="#" class="h6 author-name">Mahmoud Dayeh</a>-->
	<!--															<div class="author-company">General Manager at Absons IT Solutions and Equipments</div>-->
	...
	<!--													<div class="author-info-wrap">-->
	<!--														<div class="testimonial-img-author">-->
	<!--															<img src="<?php echo base_url("assets/site/"); ?>img/testimonial/testimonial4.png" alt="author">-->
	<!--														</div>-->
	<!--														<div class="author-info">-->
	...
	<!--													<div class="author-info-wrap">-->
	<!--														<div class="testimonial-img-author">-->
	<!--															<img src="<?php echo base_url("assets/site/"); ?>img/testimonial/testimonial5.png" alt="author">-->
	<!--														</div>-->
	<!--														<div class="author-info">-->
	<!--															<a href="#" class="h6 author-name">ThamirShamsi,</a>-->
	<!--															<div class="author-company">Business Development Manager at International Development Company</div>-->
	...
	<!--													<div class="author-info-wrap">-->
	<!--														<div class="testimonial-img-author">-->
	<!--															<img src="<?php echo base_url("assets/site/"); ?>img/testimonial/testimonial6.png" alt="author">-->
	<!--														</div>-->
	<!--														<div class="author-info">-->
	<!--															<a href="#" class="h6 author-name">Inga Leonard</a>-->
	<!--															<div class="author-company">Assistant Director at NtesWorld</div>-->
