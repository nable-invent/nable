			...
			<div class="row align-center">
				<div class="col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-12 col-sm-offset-0">
					<div class="crumina-module crumina-heading align-center">
						...
						<div>
							<h5>An Online Certificate Course/Vocational Training/Summer Training/Internship Program/Industrial Training</b></h5>
						</div>
				...
				<div class="col-lg-12 col-sm-12 ">
					<img src="<?php echo base_url('assets/site/'); ?>img/banner/ban.png" alt="image" style=" width: 100%;" class="display-block ">
					<!--style=" width: 50%;-->
					<!--margin: 0 auto;"-->
				</div>
				<!--	<div class="col-lg-12 col-sm-12">-->
					...
					<div class="swiper-container" data-effect="fade">
						<div class="swiper-wrapper">
							...
							<div class="crumina-module crumina-testimonial-item testimonial-item-author-top swiper-slide">
								...
								<h6 class="testimonial-text" data-swiper-parallax="-300">
									On 1st of July 2021, I joined NABLE INVENT SOLUTION as an Associate Trainee. Since then,
									...
									One thing I liked the most about NABLE INVENT SOLUTION is that the training provided here is not only theoretical.
									...
									I am happy to be a part of NABLE INVENT SOLUTION.
								</h6>
							...
							<div class="crumina-module crumina-testimonial-item testimonial-item-author-top swiper-slide">
								...
								<h6 class="testimonial-text" data-swiper-parallax="-300">
									I joined NABLE INVENT SOLUTION on 1st July 2021 and since then I’ve noticed many changes in my technical as well as communication skills.
									I am learning new things every day. In NABLE INVENT SOLUTION, the focus is more on practical rather than on theoretical concepts.
									Trainers are also very supportive here.
									I feel very proud to be one of the trainees of NABLE INVENT SOLUTION.
