          ...
          <form class="form-validate contact-form crumina-submit" method="post" action="<?php echo base_url('web/uploadData'); ?>" enctype="multipart/form-data">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              ...
              <p>
                ...
                Please register with NABLE INVENT SOLUTION to review your candidature.
              </p>
            ...
            <div class="row">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="with-icon">
                  <input name="name" placeholder="Your Full Name" id="name" type="text" required="true" />
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="with-icon">
                  <input name="email" placeholder="Email Address" id="email" type="text" required="true" />
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="with-icon">
                  <input name="contact" placeholder="Contact No." id="phone" type="text" required="true" />
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="with-icon">
                  <input name="percentagex" placeholder="10th Percentage" id="address" type="text" required="true" />

                </div>
              </div>
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="with-icon">
                  <input name="percentagexii" placeholder="12th percentage" id="pincode" type="text" required="true" />
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="with-icon">
                  <input name="college" placeholder="Name of College " id="expyear" type="text" required="true" />

                </div>
              </div>
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="with-icon">
                  <input name="gyop" placeholder="Graduation Pass out Year" id="skills" type="text" required="true" />

                </div>
              </div>
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="with-icon">
                  <input name="percentageg" placeholder="Graduation Percentage" id="skills" type="text" required="true" />

                </div>
              </div>
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="with-icon">
                  <input name="stream" placeholder="Stream" id="skills" type="text" required="true" />

                </div>
              </div>
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="with-icon">
                  <input name="state" placeholder="Name of the State" id="skills" type="text" required="true" />
              ...
              <h6>Attached: Resume</h1>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="with-icon">
                    <input name="resume" placeholder="Name of the State" id="skills" type="file" required="true" />
